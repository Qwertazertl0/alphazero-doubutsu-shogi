    ...
    def run_tree_search(self, root: AbstractNode) -> torch.Tensor:
        ...
        for _ in self.n_rollouts:
            ...
            while not curr_inner.is_over():
                ...
                # Expand and evaluate
                child = curr_inner.execute_action(a)
                v = child.evaluate(self.agent)
                
                # Backup
                curr_inner.backup(v, root)
                curr_inner = child
